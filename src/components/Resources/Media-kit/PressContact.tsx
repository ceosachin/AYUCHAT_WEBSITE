...
export function PressContact() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-16 sm:mt-20 lg:mt-24 mb-16 sm:mb-20 lg:mb-24">
      ...
      {/* Tag */}
      <p className="text-[10px] sm:text-xs bg-[#E6F4EF] border border-[#0B6B50]/20 text-[#0B6B50] px-3 sm:px-4 py-1 rounded-full inline-block mb-4 font-medium tracking-wide">
        PRESS CONTACT
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-8 sm:mb-10">
        ...
        {/* Sachin Card */}
        <div className="bg-[#F9FBFA] rounded-xl">
          <div className="p-4 sm:p-6 flex items-start gap-3 sm:gap-4 border border-gray-200 rounded-xl">
        ...
        {/* PR Card */}
        <div className="bg-[#F9FBFA] border border-gray-200 rounded-xl">
      ...
      <div className="bg-[#F9FBFA] border border-gray-200  rounded-xl">
        <div className="p-4 sm:p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div>
            <p className="font-semibold text-gray-900 mb-1 text-sm sm:text-base font-['Bricolage_Grotesque']">
          ...
          {/* Button */}
          <button className="bg-[#0B6B50] hover:bg-[#09543f] text-white px-5 sm:px-6 py-2.5 sm:py-3 rounded-xl flex items-center justify-center gap-2 w-full md:w-auto transition font-bold">
