  ...
  return (
    <div className="bg-[#F5F7F6] py-20 px-6">
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <span className="bg-[#E6F4EF] border border-[#0B6B50]/20 text-[#0B6B50] px-4 py-2 rounded-full text-xs font-semibold">
          HOW INTEGRATIONS WORK
        </span>

        <h2 className="text-5xl font-bold mt-4 text-[#1C1C1C] font-['Bricolage_Grotesque']">
      ...
      <div className="max-w-7xl mx-auto mt-16 grid md:grid-cols-2 gap-10">
        ...
        {/* RIGHT */}
        <div className="bg-[#02130F] text-green-400 rounded-2xl p-6 h-[500px] shadow-xl font-mono text-sm overflow-hidden">
...
const Tab = ({ label, active, onClick }: any) => (
  <button
    onClick={onClick}
    className={`px-5 py-2 rounded-full text-sm border border-gray-300 ${active ? "bg-[#0B6B50] text-white" : "bg-white"
      }`}
  >
    {label}
  </button>
...
const Step = ({ number, title, desc }: any) => (
  <div className="flex items-start gap-4 border border-gray-300 rounded-xl p-4 bg-white">
