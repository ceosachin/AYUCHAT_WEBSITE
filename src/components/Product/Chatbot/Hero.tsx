  ...
  <span className="flex items-center gap-2 border border-emerald-900/90 bg-green-900/40 text-green-400 px-3 py-2 rounded-full text-xs font-bold">
    ...
    No-Code Drag-and-Drop Builder
          ...
          <h1 className="text-5xl md:text-6xl font-bold leading-tight">
            Build WhatsApp <br />
            Chatbots. <br />
            Zero Code Required. <br />
            <span className="text-green-400">Run 24/7.</span>
          </h1>

          {/* Description */}
          <p className="text-gray-400 mt-6 max-w-lg leading-relaxed">
            AyuChat's visual drag-and-drop chatbot builder lets any business automate WhatsApp conversations — lead capture, appointment booking, FAQs, and payments — without writing a single line of code.
          </p>

          {/* Buttons */}
         <div className="flex flex-col sm:flex-row gap-4 mt-8">
  
  <button className="w-full sm:w-auto bg-green-500 hover:bg-emerald-600 px-6 py-3 rounded-lg font-semibold shadow-lg text-black transition">
    Start Free — 14 Days →
  </button>

  <button className="w-full sm:w-auto border border-white/20 px-6 py-3 rounded-lg hover:bg-white/10 transition">
    See Live Demo →
  </button>
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl">
                ...
                <p className="text-gray-300 text-sm">
                  No-Code Drag-and-Drop Builder — running for 1,000+ businesses across India
                </p>
              </div>
