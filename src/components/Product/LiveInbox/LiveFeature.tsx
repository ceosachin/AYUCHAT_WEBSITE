...
export default function LiveFeatures() {
  const features = [
    ...
    },
    {
      ...
      desc: "Send text, images, documents, videos, audio, and interactive buttons within your WhatsApp campaigns. Attach product catalogues, appointment cards, payment links, or promotional flyers",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-14 text-left">
          {features.map((item, index) => (
            ...
            >
              {/* Icon */}
              <div className='w-12 h-12 bg-[#E6F4EF] text-[#0B6B50] flex items-center justify-center rounded-xl mb-4 '>
                {item.icon}
              </div>
