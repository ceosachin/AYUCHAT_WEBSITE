    ...
    <section className="py-24 px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-14">
          ...
          {/* Bronze */}
          <div className="bg-white border border-gray-300 rounded-2xl p-8 text-left shadow-sm hover:shadow-md transition h-full flex flex-col justify-between">

            <div>
              <div className="text-center mb-6">
                <p className="text-xl font-bold font-['Bricolage_Grotesque']">Bronze Partner</p>
          ...
          {/* Silver (Highlighted) */}
          <div className="bg-[#0B6B50] text-white rounded-2xl p-8 shadow-xl  scale-105 relative flex flex-col justify-between">

            <div>
              <div className="text-center mb-6">
                <p className="text-xl font-bold font-['Bricolage_Grotesque']">Silver Partner</p>
              ...
              <ul className="space-y-3 text-white text-sm">
                <li className="flex gap-2"><Check size={18} strokeWidth={3.5}/> Everything in Bronze</li>
                <li className="flex gap-2"><Check size={18} strokeWidth={3.5}/> Priority support</li>
                <li className="flex gap-2"><Check size={18} strokeWidth={3.5}/> Co-branded materials</li>
                <li className="flex gap-2"><Check size={18} strokeWidth={3.5}/> Strategy calls</li>
                <li className="flex gap-2"><Check size={18} strokeWidth={3.5}/> Featured listing</li>
              </ul>
            </div>
          ...
          <div className="bg-white border border-gray-300 rounded-2xl p-8 text-left shadow-sm hover:shadow-md transition h-full flex flex-col justify-between">
            ...
            <div>
              <div className="text-center mb-6">
                <p className="text-xl font-bold font-['Bricolage_Grotesque']">Gold Partner</p>
                <p className="text-sm text-gray-500">31+ active referrals</p>

                <p className="text-5xl font-bold text-[#0B6B50] mt-4">
                  30%
                </p>
                ...
                <button className="mt-4 bg-green-100 text-[#0B6B50] px-4 py-2 rounded-full text-sm font-medium">
                  Maximum earnings
                </button>
              </div>
